...
export default class Edit extends Component {
    ...
    componentDidMount() {
        axios.get('http://127.0.0.1:8000/api/request/edit/' + this.props.match.params.id)
            .then(response => {
                this.setState({arequest_type:response.data.type,
    ...
    onSubmit(e) {
      ...
      //   = this.state;
        ...
        axios.put('http://127.0.0.1:8000/api/request/update/'+this.props.match.params.id,  {arequest_type:this.state.arequest_type,
